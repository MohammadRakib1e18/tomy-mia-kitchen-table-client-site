      ...
      <div className="blog-container grid lg:grid-cols-2 grid-cols-1 gap-5 mt-8">
        <div className="card w-full bg-slate-700 shadow-xl rounded-none">
          <div className="card-body">
            ...
            <div className="ml-5">
              <p>
                SQL means Structured Query Language whereas NoSQL means Not only
                SQL.
              </p>
              <br />
              ...
              <ul className="list-decimal list-inside space-y-3">
                <li>
                  ...
                  Databases (RDBMS); whereas NoSQL database are primarily called
                  as non-relational or distributed database.
                </li>
                <li>
                ...
                <li>
                  ...
                  vertically scalable. But on the other hand NoSQL databases are
        ...
        <div className="card w-full bg-slate-700 shadow-xl rounded-none">
          <div className="card-body">
            ...
            <div className="ml-5">
              <p>
                Javascript is a programming language. On the other hand, Nodejs
                is a javascript runtime. Nodejs allows Javascript code to run
                outside the browser. Nodejs comes with a lot of modules and
              ...
              <ul className="list-decimal list-inside space-y-3">
                ...
                <li>
                  It is basically used on the client-side. It is mostly used on
                  the server-side.
                </li>
                <li>
