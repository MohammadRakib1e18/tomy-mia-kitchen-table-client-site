...
const Service = ({ service }) => {
  ...
  return (
    <div className="bg-slate-700 dark:bg-slate-200 shadow-xl hover:shadow-2xl  flex flex-col justify-between">
      <div>
        <div className="h-64">
          <PhotoProvider>
        ...
        <div className="mx-3">
          ...
          <p className="text-slate-300 dark:text-slate-700">{details.slice(0,100)}</p>
        </div>
      </div>
